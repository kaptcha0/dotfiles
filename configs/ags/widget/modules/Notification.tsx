...
export default function Notification({ notification: n, timeout: t, onClose }: NotificationProps) {
  if (t && t > 0) timeout(t, () => n.dismiss())
  
  if (n.sound_file && fileExists(n.sound_file)) {
    let file = Gio.File.new_for_uri(n.sound_file);
      ...
      >
        <box class="header">
          ...
          <label
            ...
            label={time(n.time)}
          />
          <button onClicked={() => (onClose ? onClose() : n.dismiss())}>
