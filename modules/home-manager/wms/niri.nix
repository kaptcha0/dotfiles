  ...
  config = lib.mkIf cfg.enable {
    ...
    programs.niri.settings = {
      ...
      binds = {
        ...
        "Mod+Return" = {
          hotkey-overlay.title = "open a terminal: ${common.term}";
          action.spawn = common.term;
        };

        "Mod+Space" = {
          hotkey-overlay.title = "open launcher";
          action.spawn = common.launcher;
        };

        "Mod+Comma" = {
          hotkey-overlay.title = "lock the screen";
          action.spawn = common.locker;
          allow-when-locked = true;
        };

        "Mod+E" = {
          hotkey-overlay.title = "open file explorer: ${common.file-browser}";
          action.spawn = common.file-browser;
        };

        "Mod+N" = {
          hotkey-overlay.title = "open notes app: ${common.notes}";
          action.spawn = common.notes;
        };

        "Mod+B" = {
          hotkey-overlay.title = "open browser: ${common.browser}";
          action.spawn = common.browser;
        };

        "Mod+W" = {
          hotkey-overlay.title = "open code editor: ${common.editor}";
          action.spawn = common.editor;
        };
        ...
        "XF86AudioPrev" = {
          allow-when-locked = true;
          action.spawn = common.noctalia "media previous";
        };

        "XF86AudioNext" = {
          allow-when-locked = true;
          action.spawn = common.noctalia "media next";
        };
