...
function M.format()
    ...
    utils.info("Formatting file...", "Formatting")
end

function M.format_range()
  local start_range = vim.api.nvim_buf_get_mark(0, "<")
  local end_range = vim.api.nvim_buf_get_mark(0, ">")
  vim.lsp.buf.range_formatting(nil, start_range, end_range)
  utils.info("Formatting range " .. start_range ":" .. end_range, "Formatting")
end
